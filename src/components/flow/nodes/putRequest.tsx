...
const PutRequestNode: React.FC<NodeProps<PutRequestNodeData>> = (node) => {
...
const EditPutRequestNode: React.FC<NodeProps<PutRequestNodeData>> = (node) => {
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogPortal>
          <DialogContent className="max-w-[36rem]">
            <DialogHeader>
              <DialogTitle>Edit PUT Request</DialogTitle>
              <DialogDescription>
                Subheading here
              </DialogDescription>
            </DialogHeader>

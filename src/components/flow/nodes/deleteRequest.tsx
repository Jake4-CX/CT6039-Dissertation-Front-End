...
const DeleteRequestNode: React.FC<NodeProps<DeleteRequestNodeData>> = (node) => {
...
const EditDeleteRequestNode: React.FC<NodeProps<DeleteRequestNodeData>> = (node) => {
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogPortal>
          <DialogContent className="max-w-[36rem]">
            <DialogHeader>
              <DialogTitle>Edit DELETE Request</DialogTitle>
              <DialogDescription>
                Subheading here
              </DialogDescription>
            </DialogHeader>
